...
const CadastroApto = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <View>
                    <Text style={styles.subTitles}>Tempo m�ximo de reserva (Minutos)</Text>
                    <TextInput
                ...
                <View>
                    <Text style={styles.subTitles}>Outra informa��o...</Text>
                    <TextInput
                        style={styles.textInput}
                        placeholder="Coloque o tempo maximo de reserva"
                        placeholderTextColor="#7F7F7F"
                ...
                <View>
                    <Text style={styles.subTitles}>G�nero</Text>
                    <Picker
